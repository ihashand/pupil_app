...
// Funkcja wyświetlająca modal do wyboru temperatury
void showTemperatureModal(BuildContext context,
  ...
  void recordTemperatureEvent() {
    ...
    double initialTemperature =
        double.tryParse(temperatureController.text.replaceAll(',', '.')) ?? 0.0;
    if (petIds != null && petIds.isNotEmpty) {
      for (String id in petIds) {
        _saveTemperatureEvent(
            context, ref, id, initialTemperature, eventId, selectedDate);
      }
    } else if (petId != null) {
      _saveTemperatureEvent(
          context, ref, petId, initialTemperature, eventId, selectedDate);
    }
  }
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  double initialTemperature = double.tryParse(
...
// Funkcja pomocnicza do zapisu eventu temperature
