...
// Funkcja wyświetlająca modal do dodawania notatek
void showNotesModal(BuildContext context, TextEditingController titleController,
    TextEditingController contentTextController, WidgetRef ref,
