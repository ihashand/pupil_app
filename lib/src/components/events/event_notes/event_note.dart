...
class EventNote extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EventNote> createState() => _EventNoteState();
}

class _EventNoteState extends ConsumerState<EventNote> {
  @override
